...
namespace ClientesApp {
    ...
    public partial class masterDataSet : global::System.Data.DataSet {
        ...
        public partial class clientesDataTable : global::System.Data.TypedTableBase<clientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public clientesRow AddclientesRow(string nome, string email, string CPF, string telefone) {
...
namespace ClientesApp.masterDataSetTableAdapters {
    ...
    public partial class clientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[clientes] WHERE (([id] = @Original_id) AND ([nome] = @Original" +
                "_nome) AND ([email] = @Original_email) AND ([CPF] = @Original_CPF) AND ([telefon" +
                "e] = @Original_telefone))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[clientes] ([nome], [email], [CPF], [telefone]) VALUES (@nome, " +
                "@email, @CPF, @telefone);\r\nSELECT id, nome, email, CPF, telefone FROM clientes W" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[clientes] SET [nome] = @nome, [email] = @email, [CPF] = @CPF, [telefone] = @telefone WHERE (([id] = @Original_id) AND ([nome] = @Original_nome) AND ([email] = @Original_email) AND ([CPF] = @Original_CPF) AND ([telefone] = @Original_telefone));
SELECT id, nome, email, CPF, telefone FROM clientes WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ClientesApp.Properties.Settings.Default.masterConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nome, email, CPF, telefone FROM dbo.clientes";
        ...
        public virtual int Fill(masterDataSet.clientesDataTable dataTable) {
        ...
        public virtual masterDataSet.clientesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            masterDataSet.clientesDataTable dataTable = new masterDataSet.clientesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(masterDataSet.clientesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_nome, string Original_email, string Original_CPF, string Original_telefone) {
        ...
        public virtual int Update(string nome, string email, string CPF, string telefone, int Original_id, string Original_nome, string Original_email, string Original_CPF, string Original_telefone, int id) {
            if ((nome == null)) {
                throw new global::System.ArgumentNullException("nome");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nome, string email, string CPF, string telefone, int Original_id, string Original_nome, string Original_email, string Original_CPF, string Original_telefone) {
            return this.Update(nome, email, CPF, telefone, Original_id, Original_nome, Original_email, Original_CPF, Original_telefone, Original_id);
        }
    }
